...
export default function Footer() {
  ...
  const HEADING = "mb-4 text-base md:text-lg font-semibold uppercase border-b border-blue-700 pb-2";
  const LINK_FOOT = "text-blue-100 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70";
  const ICON_BTN = "inline-flex h-9 w-9 items-center justify-center bg-blue-800 text-white hover:text-blue-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/70 rounded-full";
  const year = new Date().getFullYear();

  // JSON-LD (SEO) con dominio y contacto reales
  const orgJsonLd = {
  ...
  return (
    <footer className="bg-blue-900 text-white" aria-labelledby="footer-heading" role="contentinfo">
      ...
      <div className={`${WRAP} py-12 lg:py-16`}>
          ...
          <address aria-labelledby="footer-contact" className="not-italic">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <FaMapMarkerAlt className="mr-3 mt-0.5 h-5 w-5 flex-shrink-0 text-blue-300" aria-hidden="true" />
                <span className="text-blue-100">Quito, Ecuador</span>
              </li>
              <li className="flex items-start">
                <FaEnvelope className="mr-3 mt-0.5 h-5 w-5 flex-shrink-0 text-blue-300" aria-hidden="true" />
                <a href="mailto:soporte@safetech-ec.com" className={LINK_FOOT}>soporte@safetech-ec.com</a>
              </li>
              <li className="flex items-start">
                <FaPhoneAlt className="mr-3 mt-0.5 h-5 w-5 flex-shrink-0 text-blue-300" aria-hidden="true" />
                <a href="tel:+593999047935" className={LINK_FOOT}>+593 999 047 935</a>
              </li>
              <li className="flex items-start">
                <FaWhatsapp className="mr-3 mt-0.5 h-5 w-5 flex-shrink-0 text-blue-300" aria-hidden="true" />
        ...
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          <span className="text-sm text-blue-200">© {year} CK System. Todos los derechos reservados.</span>
