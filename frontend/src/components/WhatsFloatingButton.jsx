...
export default function WhatsFloatingButton() {
  ...
  const whatsappNumber = "593999047935";
  const phoneDisplay = "099 904 7935";
    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          style={{ boxShadow: "0 4px 20px rgba(37, 211, 102, 0.5)", animation: "pulse 2s infinite" }}
      ...
      {/* Overlay + Modal */}
      {isModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4 md:block" aria-label="Fondo de diálogo de WhatsApp">
          <div
            ref={modalRef}
            className={
          ...
          >
            ...
            <div className="bg-[#25D366] p-4 flex justify-between items-center">
              ...
              <button onClick={() => setIsModalOpen(false)} className="text-white hover:text-green-200 transition-colors duration-200" aria-label="Cerrar panel de WhatsApp">
            ...
            <div className="max-h-[70vh] overflow-y-auto md:max-h-none md:overflow-visible">
              ...
              <div className="bg-gray-100 p-3 text-center">
                <p className="text-xs text-gray-500">
                  Tel: <a href={`tel:${phoneDisplay}`} className="text-[#25D366] font-medium">{phoneDisplay}</a>
                  <br />
