...
export default function SafeServicios() {
  ...
  return (
    <div className="relative bg-black isolate">
      ...
      {/* NUEVA 1 — APLICACIÓN DEDICADA (EN FILITA, MISMO ESTILO QUE “¿POR QUÉ…?”) */}
      <section className="relative z-10">
        <div className="mx-auto max-w-6xl px-4 py-10 md:py-14">
          ...
          {/* MISMO LAYOUT: 3 columnas, centrado, con separadores a la derecha en md */}
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3">
            {[
              ...
              >
                {/* Icono dentro de contenedor con tono dorado suave */}
